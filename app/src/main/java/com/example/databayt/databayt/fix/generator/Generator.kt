package com.example.databayt.databayt.fix.generator
...
fun Generator (navController: NavController) {
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(id = R.string.generatorhead),
                style = Head2,
            )
        ...
        )
        {
                ...
                border = BorderStroke(width = 0.2.dp, color = Color.Gray))
            {
                Column() {
                    Box(modifier = Modifier.background(OffWhite)){
                        Image(
                            painter = painterResource(id = R.drawable.d40),
                            contentDescription = "null",
                            contentScale = ContentScale.Crop)
                    }
                ...
                border = BorderStroke(width = 0.2.dp, color = Color.Gray))
            {
                Column() {
                    Box(modifier = Modifier.background(OffWhite)){
                        Image(
                            painter = painterResource(id = R.drawable.de33),
                            contentDescription = "null",
                            contentScale = ContentScale.Crop)
                    }
